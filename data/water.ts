export const waterProgram = {
  title: "Water & Sanitation",
  subtitle: "Clean Water Changes Everything",
  description:
  ...
  reportHref: "/documents/reports/water-report.pdf",
  sdgs: ["SDG 3", "SDG 6", "SDG 13", "SDG 17"],

  stats: [
    ["3,246+", "Wells Constructed"],
    ["700+", "Boreholes Built"],
    ["1,000+", "Boreholes Renovated"],
    ["3,946", "Water Points Established"],
    ["2M+", "People Reached"],
    ["19", "Northern States"],
    ["57+", "LGAs Impacted"],
    ["285+", "Communities Benefited"],
  ],
  ...
  interventions: [
    ...
    "Renovation of existing boreholes",
    "Water quality testing",
    "Hygiene awareness campaigns",
    "Community sensitization",
    "Water user committees",
    "Water conservation and sanitation training",
  ],

  locations: [
    {
      state: "Katsina",
      areas: ["Batagarawa", "Kankara", "Faskari", "Bakori"],
    },
    {
      state: "Kano",
      areas: ["Gezawa", "Kumbotso", "Ungogo", "Doguwa"],
    },
    {
      state: "Kaduna",
      areas: ["Chikun/Kajuru", "Igabi", "Makarfi"],
    },
    {
      state: "Jigawa",
      areas: ["Babura", "Yankwashi", "Sule Tankarkar", "Maigatari"],
    },
    {
      state: "Bauchi",
      areas: ["Bauchi Municipal", "Toro", "Ganjuwa", "Dass", "Tafawa Balewa"],
    },
  ],
  ...
  testimonials: [
    {
      ...
      name: "Jamila Umar Sani",
      location: "Dutsen Remi Village",
    },
    {
      quote:
      ...
      name: "Aliyu Madibo",
      location: "Community Beneficiary",
    },
    {
      quote:
