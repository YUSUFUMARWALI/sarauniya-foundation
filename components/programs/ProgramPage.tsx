    ...
    <main className="min-h-screen bg-[#f8f5ef] text-[#062B5F]">
      <section className="bg-[#062B5F] px-6 py-20 text-white md:px-16 lg:px-24">
        <div className="mx-auto max-w-7xl">
          <Link href="/programs" className="inline-flex items-center gap-2 text-white/80 hover:text-white">
      ...
      <section className="px-6 py-16 md:px-16 lg:px-24">
        <div className="mx-auto max-w-7xl">
          <h2 className="text-4xl font-bold">SCF Interventions</h2>

          <div className="mt-10 grid gap-5 md:grid-cols-2">
            {program.interventions.map((item) => (
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            {program.sdgs.map((sdg) => (
              <span key={sdg} className="rounded-full bg-[#0B4EA2] px-5 py-3 font-semibold text-white">
                {sdg}
              </span>
            ))}
          </div>
